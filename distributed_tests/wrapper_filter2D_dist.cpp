...
int main() {
    ...
    Halide::Buffer<uint64_t> buff_input = Halide::Buffer<uint64_t>(_COLS, _ROWS / NODES + 2, _CHANNELS);
    ...
    Halide::Buffer<uint64_t> buff_output(_COLS - 2, rank == NODES - 1 ? _ROWS / NODES - 2 : _ROWS / NODES, _CHANNELS);
