...
int main() {
    ...
    // now we have [i1, i2, j1, j2]
    RGB2Gray_s0.split(i2, 10, i3, i4);
    // now we have [i1, i3, i4, j1, j2]
    RGB2Gray_s0.split(i3, 1, i5, i6);
    // now we have [i1, i5, i6, i4, j1, j2]
    RGB2Gray_s0.interchange(i5, i6);
    // now we have [i1, i6, i5, i4, j1, j2]
    RGB2Gray_s0.tag_gpu_level(i5, i4, j1, j2);
